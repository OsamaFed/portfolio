...
export const constellations: Constellation[] = [
  ...
  },
  {
    name: "cancer",
    stars: [
      { name: "beta Cancri",      x: cancerOffset.x + 0.6, y: cancerOffset.y + 0.3,  size: 0.025 },
      { name: "Acubens",          x: cancerOffset.x + 0.7, y: cancerOffset.y + 1.8,  size: 0.025 },
      { name: "Asellus Australis",x: cancerOffset.x + 2.1, y: cancerOffset.y + 1.2,  size: 0.025 },
      ...
      { name: "Asellus Borealis", x: cancerOffset.x + 2.7, y: cancerOffset.y + 1.2,  size: 0.025 },
      { name: "Iota Cancri",      x: cancerOffset.x + 4.0, y: cancerOffset.y + 1.99, size: 0.025 },
      { name: "chi Cancri",       x: cancerOffset.x + 4.0, y: cancerOffset.y + 0.5,  size: 0.025 },
    ],
    delay: 0.3,
  ...
  },
  {
    name: "Scorpius",
    stars: [
      { name: "Antares",    x: scorpiusOffset.x + 1.5,  y: scorpiusOffset.y + -3.5,  size: 0.030 },
      { name: "Acrab",      x: scorpiusOffset.x + 1.5,  y: scorpiusOffset.y + -2.0,  size: 0.025 },
      { name: "Dschubba",   x: scorpiusOffset.x + 2.1,  y: scorpiusOffset.y + -2.2,  size: 0.025 },
      { name: "Pi Sco",     x: scorpiusOffset.x + 2.6,  y: scorpiusOffset.y + -2.6,  size: 0.025 },
      ...
      { name: "Mu1 Sco",    x: scorpiusOffset.x + 2.4,  y: scorpiusOffset.y + -7.1,  size: 0.018 },
      { name: "Mu2 Sco",    x: scorpiusOffset.x + 2.49, y: scorpiusOffset.y + -7.1,  size: 0.018 },
      { name: "Zeta1 Sco",  x: scorpiusOffset.x + 2.6,  y: scorpiusOffset.y + -9.5,  size: 0.020 },
      { name: "Zeta2 Sco",  x: scorpiusOffset.x + 2.7,  y: scorpiusOffset.y + -9.4,  size: 0.020 },
      ...
      { name: "Eta Sco",    x: scorpiusOffset.x + 1.8,  y: scorpiusOffset.y + -10.4, size: 0.020 },
      ...
      { name: "Shaula",     x: scorpiusOffset.x + 0.1,  y: scorpiusOffset.y + -9.4,  size: 0.027 },
      { name: "Lesath",     x: scorpiusOffset.x + 0.28, y: scorpiusOffset.y + -9.4,  size: 0.027 },
    ],
    delay: 0.7,
