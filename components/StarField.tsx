...
const constellations = [
  {
    ...
    stars: [
      ...
      { x: -4.2, y:  2.8, size: 0.011, name: "Pi1 Ori" },
      { x: -4.0, y:  2.2, size: 0.011, name: "Pi2 Ori" },
      { x: -4.3, y:  1.5, size: 0.012, name: "Pi3 Ori" },
      { x: -4.5, y:  0.8, size: 0.011, name: "Pi4 Ori" },
      { x: -4.6, y:  0.1, size: 0.011, name: "Pi5 Ori" },
      { x: -4.4, y: -0.6, size: 0.011, name: "Pi6 Ori" },
    ],
    lines: [
