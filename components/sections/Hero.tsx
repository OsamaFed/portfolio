...
const avatarBlurDataURL = "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iOTAiIGhlaWdodD0iOTAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHJlY3Qgd2lkdGg9IjEwMCUiIGhlaWdodD0iMTAwJSIgZmlsbD0iIzE0MTQxNCIvPjwvc3ZnPg=="
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    setAge(getAge(birth))
    const interval = setInterval(() => setAge(getAge(birth)), 1000)
